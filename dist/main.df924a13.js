...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../node_modules/scroll-behavior-polyfill/dist/index.js":[function(require,module,exports) {
...
var addIntersectedClass = function addIntersectedClass() {
...
function onScroll(target, initialDistanceToTop, reverse) {
  ...
  var targetDistanceToTop = target.getBoundingClientRect().top;
  var distanceRatio = targetDistanceToTop / initialDistanceToTop;
  reverse ? background.style.opacity = distanceRatio : background.style.opacity = 1 - distanceRatio;
  ...
  var observer = new IntersectionObserver(function (entries) {
    entries.forEach(function (_ref) {
      var isIntersecting = _ref.isIntersecting,
          target = _ref.target;
      var initialDistanceToTop = target.getBoundingClientRect().top;
      ...
      if (isIntersecting) {
        ...
        ;
        var reverse = target.classList.contains("section--neutral");

        window.onscroll = function () {
          return onScroll(target, initialDistanceToTop, reverse);
        };
...
document.addEventListener("DOMContentLoaded", function () {
  addIntersectedClass(); // changeBackgroundColor();
});
},{"scroll-behavior-polyfill":"../node_modules/scroll-behavior-polyfill/dist/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
